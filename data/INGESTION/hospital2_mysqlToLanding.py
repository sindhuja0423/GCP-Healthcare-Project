...
GCS_BUCKET = "hospital-1bucket_02-27-26"
...
BQ_PROJECT = "project-dd3b2aab-6af2-4164-8a1"
...
# MySQL Configuration
MYSQL_CONFIG = {
    "url": "jdbc:mysql://10.8.128.6:3306/hospital-2db?useSSL=false&allowPublicKeyRetrieval=true",
    "driver": "com.mysql.cj.jdbc.Driver",
    "user": "myuser",
    "password": "m^@+a%AM8)orS<,D"
}
...
def get_latest_watermark(table_name):
    query = f"""
        ...
        FROM `{BQ_AUDIT_TABLE}`
        WHERE tablename = '{table_name}' and data_source = "hospital-2db"
    """
...
for row in config_df.collect():
    if row["is_active"] == '1' and row["datasource"] == "hospital-2db": 
